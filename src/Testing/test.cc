...
TEST(CalcTest, Test2) {
  s21::Model model;
  s21::Controller controller(&model);
  EXPECT_LT(std::abs(controller.calculate("tan(10)+cos(1)+10-sqrt(196)+log(5)",
                                          NULL) -
                     (-2.112366)),
            1e-6);
}
...
TEST(CalcTest, Test3) {
  s21::Model model;
  s21::Controller controller(&model);
  EXPECT_LT(std::abs(controller.calculate("tan(10)+cos(1)+10-sqrt(196)+log(50)",
                                          NULL) -
                     (-1.112366)),
            1e-6);
}
...
TEST(CalcTest, Test4) {
  s21::Model model;
  s21::Controller controller(&model);
  EXPECT_LT(std::abs(controller.calculate(
                         "1+2-3/4*5^6+sin(3.1415927)+cos(3.1415927/"
                         "2)+sqrt(2)+2mod(2)+tan(1)+ln(2)+log(10)+asin(0.3)+"
                         "acos(0.1)+atan(0.6)+(-2)+(1-(+2))",
                         NULL) -
                     (-11711.769490)),
            1e-6);
}
...
TEST(CalcTest, Test6) {
  ...
  s21::Controller controller(&model);
  EXPECT_LT(std::abs(controller.calculate(
                         "x+2-3/4*5^6+sin(3.1415927)+cos(3.1415927/"
                         "2)+sqrt(2)+2mod(2)+tan(x)+ln(2)+log(x*10)+asin(0.3)+"
                         "acos(x/10)+atan(0.6)+(-2)+(x-(+2))",
                         "1") -
                     (-11711.769490)),
            1e-6);
}
...
TEST(CalcTest, Test7) {
  ...
  s21::Controller controller(&model);
  EXPECT_ANY_THROW(
      controller.calculate("x+2.-3/4*5^6+sin(3.1415927)+cos(3.1415927/"
                           "2)+sqrt(2)+2mod(2)+tan(x)+ln(2)+log(x*10)+asin(0.3)"
                           "+acos(x/10)+atan(0.6)+(-2)+(x-(+2))",
                           "1"));
}
...
TEST(CalcTest, Test15) {
  ...
  double answer[] = {8333.33, 7500.00, 6666.67, 5833.33, 5000,
                     4166.67, 3333.33, 2500.00, 1666.67, 833.33};
