...
namespace s21 { 
   ...
   void Controller::set_Xmax(const double& d) noexcept {
    model->set_Xmax(d); 
    }
    void Controller::set_Xmin(const double& d) noexcept {
    model->set_Xmin(d); 
    }
    void Controller::set_Ymin(const double& d) noexcept {
    model->set_Ymin(d); 
    }
     void Controller::set_Ymax(const double& d) noexcept {
    model->set_Ymax(d); 
    }
    ...
    double Controller::get_Xmax() const noexcept { 
        return model->get_Xmax();
    }
    double Controller::get_Xmin() const noexcept { 
        return model->get_Xmin();
    }
    double Controller::get_Ymax() const noexcept { 
        return model->get_Ymax();
    }
        double Controller::get_Ymin() const noexcept { 
    ...
    void Controller::annuityPaymentCalculation(const char *monthString, const char *loanAmounString,
    ...
    void Controller::differentiatedPayment(const char *monthString,
     ...
     const double* Controller::get_data_arrayOfMonthlyPayment_differentiatedPayment() const noexcept { 
